...
// branch, so the base-branch protection has to be stated here explicitly,
// not assumed from the allowlist.
export function buildTaskPrompt(rawTaskText, baseBranch = 'main') {
  return [
    rawTaskText.trim(),
    '',
    '---',
